...
### FR-5: 励ましメッセージ（時間帯連動・ポジティブメッセージ）
つわりを耐えている奥様の生活リズム（朝・昼・夜・深夜）に寄り添い、心身をいたわりポジティブになれるメッセージを表示する。
- **朝（5:00〜10:59）**: 朝起きられたことを肯定し、無理をさせない言葉（例: `「朝起きられただけで百点満点だよ🌱 無理せず横になっててね。」` `「何もできなくて大丈夫、休むのが今のお仕事だよ。」`）
- **昼（11:00〜16:59）**: 食べられない不安を和らげ、前進を伝える言葉（例: `「食べられる時に、食べられるものだけで大丈夫だよ。ゼリーでも氷でも◎」` `「1分1秒、確実にゴールに近づいているよ🌱」`）
- **夕方・夜（17:00〜21:59）**: 今日1日を耐え抜いたねぎらいと前進の実感（例: `「今日も1日耐えてえらい！本当によく頑張ったね、お疲れ様💐」` `「今日を乗り切った分、出口にまた一歩確実に近づいたよ✨」`）
- **深夜・早朝（22:00〜4:59）**: 暗い寝室で目が覚めた時の不安や孤独を包み込む言葉（例: `「夜中に目が覚めちゃったかな。ゆっくり深呼吸して横になっててね🌙」` `「眠れなくても、目を閉じて横になっているだけで身体は休まっているよ🌱」`）
- **タップ切り替え**: メッセージ部分をタップすると、その時間帯の別の温かいメッセージにふんわり切り替わる。
